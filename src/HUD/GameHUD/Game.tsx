...
const ObservedPlayer = ({
  ...
  return (
    <>
      {player ? (
        <div
          className={`playerInfoBlock ${player.team_name} ${
            !show ? "hide" : ""
          }`}
        >
          <div
              ...
              {player.kills ? (
                <>
                  {player.kill_list.map((killEntry) => {
                    ...
                    if (!victim || !victim.hero || !victim.hero.name)
                      return null;
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    mode="normal"
                    in2="shape"
                    result="effect1_innerShadow_103_85"
                  />
                </filter>
              </defs>
            </svg>
          ...
          <div className="playerAvatar">
            ...
            {player.avatar ? (
              <img className="playerAvatarImg" src={player.avatar} alt="" />
            ) : null}
            <svg
